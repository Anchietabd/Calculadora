...
local elementWide = elementWidth * 3 -- botão com o dobro do tamanho
...
secondaryText:setFillColor(0.8)
...
local tabButtons = {
  { label = "CE", height = elementHeight, width = elementWidth, x = gridX[1], y = gridY[3], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleClearButtonsEvent    },
  { label = "C",  height = elementHeight, width = elementWidth, x = gridX[2], y = gridY[3], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleClearButtonsEvent    },
  { label = "←", height = elementHeight, width = elementWidth, x = gridX[3], y = gridY[3], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleClearButtonsEvent    },
  { label = "÷",  height = elementHeight, width = elementWidth, x = gridX[4], y = gridY[3], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleOperatorsButtonEvent },
  { label = "7",  height = elementHeight, width = elementWidth, x = gridX[1], y = gridY[4], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "8",  height = elementHeight, width = elementWidth, x = gridX[2], y = gridY[4], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "9",  height = elementHeight, width = elementWidth, x = gridX[3], y = gridY[4], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "×",  height = elementHeight, width = elementWidth, x = gridX[4], y = gridY[4], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleOperatorsButtonEvent },
  { label = "4",  height = elementHeight, width = elementWidth, x = gridX[1], y = gridY[5], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "5",  height = elementHeight, width = elementWidth, x = gridX[2], y = gridY[5], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "6",  height = elementHeight, width = elementWidth, x = gridX[3], y = gridY[5], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "-",  height = elementHeight, width = elementWidth, x = gridX[4], y = gridY[5], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleOperatorsButtonEvent },
  { label = "1",  height = elementHeight, width = elementWidth, x = gridX[1], y = gridY[6], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "2",  height = elementHeight, width = elementWidth, x = gridX[2], y = gridY[6], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "3",  height = elementHeight, width = elementWidth, x = gridX[3], y = gridY[6], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = "+",  height = elementHeight, width = elementWidth, x = gridX[4], y = gridY[6], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleOperatorsButtonEvent },
  { label = "0",  height = elementHeight, width = elementWide,  x = gridX[1], y = gridY[7], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleNumbersButtonEvent   },
  { label = ".",  height = elementHeight, width = elementWidth, x = gridX[3], y = gridY[7], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onEvent = handleDotButtonEvent       },
  { label = "=",  height = elementHeight, width = elementWidth, x = gridX[4], y = gridY[7], shape = "rect", strokeWidth = 1, strokeColor = { default={ 0.8 }, over={ 0.8 } }, onRelease = handleEqualButtonEvent   }
}
